...
contract People {
    //We need an array to represent the people
    Person[] public people;

    // The struct data object representing a person
    struct Person {
        bytes32 firstName;
        bytes32 lastName;
        uint age;
    ...
    function addPerson(bytes32 _firstName, bytes32 _lastName, uint _age) returns (bool success) {
        ...
        //The transaction of adding new person to people array
        people.push(newPerson);
        return true;
    }

    // In Solidity you CANNOT return a Struct
